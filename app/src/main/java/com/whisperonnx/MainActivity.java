...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabCopy.setOnClickListener(v -> {
            ...
            ClipData clip = ClipData.newPlainText(
                    getString(R.string.model_output), textToCopy);
        ...
        mRecorder.setListener(new Recorder.RecorderListener() {
            @Override public void onUpdateReceived(String message) {
                ...
                if (message.equals(Recorder.MSG_RECORDING)) {
                    ...
                    runOnUiThread(() -> btnRecord.setBackgroundResource(
        ...
        // FreeDroidWarn and GithubStar dialogs intentionally removed.
        checkPermissions();
    }
    ...
    private void checkInputMethodEnabled() {
        ...
        String myId = getPackageName() + "/" + WhisperInputMethodService.class.getName();
        boolean enabled = false;
        for (InputMethodInfo imi : list) {
            if (imi.getId().equals(myId)) { enabled = true; break; }
        }
        if (!enabled) startActivity(new Intent(Settings.ACTION_INPUT_METHOD_SETTINGS));
    }
        ...
        mWhisper.setListener(new Whisper.WhisperListener() {
            ...
            @Override public void onResultReceived(WhisperResult whisperResult) {
                ...
                runOnUiThread(() -> tvStatus.setText(
                        ...
                        + " " + (whisperResult.getTask() == ACTION_TRANSCRIBE
    ...
    private void startProcessing(Recognizer.Action action) {
        ...
        mWhisper.setLanguage(sp.getString("language", "auto"));
        mWhisper.start();
    }
